"""Right-seat configuration for the universal player defense Activity."""

from activities.player_defense_activity import PlayerDefenseActivity


class RightPlayerDefenseActivity(PlayerDefenseActivity):
    """Use the shared upright shield frames for the right seat."""
